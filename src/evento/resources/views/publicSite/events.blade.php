  ...
  <div class="container">
    ...
    <div class="row justify-content-center mb-5 pb-2">
      <div class="col-md-8  heading-section ftco-animate">
        <h3 class="mb-2"><span>All</span> Events</h3>
    ...
    <div class="row"> 
      ...
      {{-- start aside div - top categories --}}
       <div class="col-lg-2 " style="border-right: solid .5px rgb(194, 194, 194); margin-left: 20px;">
      ...
      {{-- main content --}}
      <div class="col-8 d-flex justify-content-center flex-wrap gap-5 m-auto">
        ...
        <div class="col-md-4 col-sm-8 mb-2 " style="max-width: fit-content; overflow:hidden">
          <div class="card" style="width: 18rem; ">
            ...
            <div class="card-body">
              ...
              <a href="{{ route('event', $event->id ) }}" class="btn btn-primary">Discover Now </a>
            </div>
          </div>
        </div>
        @endforeach
