...
<head>
  <title>Evento- @section('title','home')</title>
  <meta charset="utf-8">
...
<body>
      ...
      <div class="collapse navbar-collapse " id="ftco-nav">
        <ul class="navbar-nav mr-auto float-right">
          ...
          <li class="nav-item  submenu dropdown">
            ...
            <a href="{{ route('allEvents' )}}" class="nav-link ">Categories</a>
            @isset($categories)
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate align-self-center d-flex flex-column-reverse align-items-center"> 
            ...
            {{-- End Searh part --}}
            <p><a href="{{ route('allEvents') }}" class=" btn btn-primary px-4 py-1 rounded-pill mt-3">Explore!</a>
            </p>
            <h5 class="subheading text-truncate w-50"></h5>
          </div>
        </div>
     ...
     <div class="row no-gutters">
        ...
        <div class="col-md-3">
          <div class="project img ftco-animate d-flex justify-content-center align-items-center"
            style="background-image: url({{$category->image}});  background-position: center; background-size: cover;">
            <div class="overlay"></div>
  ...
  <section class="ftco-section bg-light">
    <div class="container">
      <div class="row justify-content-center mb-5 pb-2">
        <div class="col-md-8 text-center heading-section ftco-animate">
          <h2 class="mb-4"><span>Latest Events</span> </h2>
          <p>Separated they live in. A small river named Duden flows by their place and supplies it with the necessary
            regelialia. It is a paradisematic country</p>
        </div>
      </div>
        ...
        <div class="col-md-6 col-lg-2">
          <div class="ftco-footer-widget mb-5 ml-md-4">
            ...
            <ul class="list-unstyled">
              @foreach ($categories as $category )
              <li class="nav-item">
                <li><a href="{{ route('allEvents',$category->id )}}"><span class="ion-ios-arrow-round-forward mr-2"></span>{{ $category->name }}</a></li>
          ...
          <div class="ftco-footer-widget mb-5 ml-md-4">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="{{ 'about' }}"><span class="ion-ios-arrow-round-forward mr-2"></span>About</a></li>
               <li><a href="{{ route('allEvents' )}}"><span
                    class="ion-ios-arrow-round-forward mr-2"></span>Events</a></li> 
            </ul>
          </div>
        </div>
        <div class="col-md-6 col-lg-2">
          <div class="ftco-footer-widget mb-5">
            ...
            <div class="block-23 mb-3">
              <ul>
                ...
                <li><span class="icon icon-phone"></span><span class="text">+962 392 392 210</span></li>
                <li><span class="icon icon-envelope"> </span><span class="text ">Evento@gmail.com</span> </li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="col-md-12 text-center">
        ...
        <p>
          ...
          Copyright &copy;<script>
            ...
            href="https://google.com" target="_blank">Reem Bani Ali</a>
          <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
        </p>
      </div>
    </div>
